...
import (
	...
	_ "github.com/okok7711/gitea/cmd" // for TestPrimaryKeys
...
func TestPrimaryKeys(t *testing.T) {
	...
	// Import "github.com/okok7711/gitea/cmd" to make sure each db.RegisterModel in init functions has been called.
