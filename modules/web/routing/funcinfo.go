...
// shortenFilename generates a short source code filename from a full package path, eg: "github.com/okok7711/routers/common/logger_context.go" => "common/logger_context.go"
